...
public class TextureRegion
{
    ...
    /// <summary>
    /// Provides the Width of the in pixels of this texture region.
    /// </summary>
    public int Width => SourceRectangle.Width;

    /// <summary>
    /// Provides the height in pixels of this texture region.
    /// </summary>
    ...
    /// <summary>
    /// Create a new Texture Region with a given texture, and srcRec Size
    /// </summary>
    /// <param name="texture"> The texture to use as the source for this texture region.</param>
    /// <param name="x"> The X coordinate for the upper left corner of this texture region.</param>
    /// <param name="y">The Y coordinate for the upper left corner of this texture region.</param>
    /// <param name="width"> The width in pixels fo this texture region.</param>
