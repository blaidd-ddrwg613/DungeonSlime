...
{
    /// <summary>
    /// Store the state of the mouse from the last frame
    /// </summary>
    public MouseState PreviousState { get; private set; }
    
    /// <summary>
    /// Stores the state of the mouse form the current Frame.
    /// </summary>
    ...
    /// </summary>
    /// <remarks>Use ScrollWheelDelta when you need to respond to how much the user just scrolled,
    /// rather than tracking the total scroll amount.</remarks>
