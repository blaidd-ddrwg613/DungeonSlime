...
/// <summary>
/// A Collection of regions that make up all of our sprites
/// TextureRegion > TextureAtlas
/// </summary>
public class TextureAtlas
{
    // Stores named textureRegions allowing use to retrieve them by name
    private Dictionary<string, TextureRegion> _regions;

    // Stores animations added by this atlas.
